...
<html>
  ...
  <div id="bigbox">
  	...
  	<dir id="midbox" style="background-image: url(pic/mid.jpg)">
  		<form name="stockdrugForm" method="post" action="${pageContext.request.contextPath }/user/stockdrugupdate.do">
		...
		<c:forEach items="${stokdrugList }" var="stokdrug">
			<tr>
			<td>单据号</td>
			<td><input type="text" name="bill_id" value="${stokdrug.bill_id}"/></td>
			</tr>
			<tr>
			<td>药品编码</td>
			<td><input type="text" name="drug_id" value="${stokdrug.drug_id}"/></td>
			</tr>
			<tr>
			<td>采购价</td>
			<td><input type="number" name="price" value="${stokdrug.price}"/></td>
			</tr>
			<tr>
			<td>采购数量</td>
			<td><input type="number" name="buy_num" value="${stokdrug.buy_num}"/></td>
			</tr>
			<tr>
			<td>采购日期</td>
			<td><input type="date" name="date" value="${stokdrug.date}"/></td>
			</tr>
			<tr>
			<td>供应商</td>
			<td><input type="text" name="supplier" value="${stokdrug.supplier}"/></td>
			</tr>
			<tr>
			<td><input type="submit" value="确认"/></td>
				...
				<tr>
						<input type="hidden" name="id" value="${stokdrug.id}"/>
